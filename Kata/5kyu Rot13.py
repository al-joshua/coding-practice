...
def rot13(message):
    lower = maketrans(ascii_lowercase, ascii_lowercase[13:] + ascii_lowercase[:13])
    upper = maketrans(ascii_uppercase, ascii_uppercase[13:] + ascii_uppercase[:13])
    return message.translate(upper).translate(lower)