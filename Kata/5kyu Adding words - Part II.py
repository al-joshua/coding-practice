...
Input - Will be between zero and five hundred and will always be in lower case. This input range applies to both the
initial value upon object instantiation as well as the input for the add method.

Output - Word representation of the result of the addition. Should be in lower case

Word format - Both input and output shall be in the format 123 = one hundred and twenty three. No hyphen is needed
in numbers 21-99. Words should also be separated with one space and no space padding is allowed."""
